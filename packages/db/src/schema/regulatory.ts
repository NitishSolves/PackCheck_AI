...
export const regulatorySources = pgTable(
  ...
  (table) => [index('regulatory_sources_verification_status_idx').on(table.verificationStatus)],
);
...
export const ruleConditions = pgTable(
  ...
  (table) => [index('rule_conditions_rule_version_id_idx').on(table.ruleVersionId)],
);
...
export const ruleProposals = pgTable(
  ...
  (table) => [index('rule_proposals_source_id_idx').on(table.sourceId)],
);
